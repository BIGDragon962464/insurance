<template>
    <div style="padding: 10px; margin-bottom: 50px">
        <el-row>
            <el-col :span="2">
                <el-card style="width: 230px; height: 300px; color: #333">
                    <div style="padding-bottom: 10px; border-bottom: 1px solid #ccc">在线用户
                        <span style="font-size: 12px">（点击气泡聊天）</span>
                    </div>
            ...
            <el-col :span="22">
                <div style="width: 700px; margin: 0 auto; background-color: white; border-radius: 5px; box-shadow: 0 0 10px #ccc">
                    ...
                    <div style="height: 180px">
                        <textarea v-model="text" style="height: 120px; width: 100%; padding: 20px; border: none; border-top: 1px solid #ccc; border-bottom: 1px solid #ccc; outline: none"></textarea>
                        <div style="text-align: right; padding-right: 10px">
                            <el-button style="margin-top: 10px" type="primary" size="mini" @click="send">发送</el-button>
                        </div>
                    </div>
                </div>
            </el-col>
